# BEAT Agent Command Patterns Reference
...
<!-- Standard workflow -->
<item cmd="*create-prd"
     run-workflow="{project-root}/{beat_folder}/beat-method/workflows/prd/workflow.yaml">
...
<item cmd="*validate-prd"
     ...
     workflow="{project-root}/{beat_folder}/beat-method/workflows/prd/workflow.yaml">
...
<!-- Task with data -->
<item cmd="*standup"
   exec="{project-root}/{beat_folder}/mmm/tasks/daily-standup.xml"
   data="{project-root}/{beat_folder}/_cfg/agent-manifest.csv">
...
```xml
<item cmd="*brief"
   exec="{project-root}/{beat_folder}/core/tasks/create-doc.md"
   tmpl="{project-root}/{beat_folder}/beat-method/templates/brief.md">
  Produce Project Brief
</item>

<item cmd="*competitor-analysis"
   exec="{project-root}/{beat_folder}/core/tasks/create-doc.md"
   tmpl="{project-root}/{beat_folder}/beat-method/templates/competitor.md"
   data="{project-root}/{beat_folder}/_data/market-research.csv">
...
<item cmd="*list-tasks"
   action="list all tasks from {project-root}/{beat_folder}/_cfg/task-manifest.csv">
...
<agent name="Research Assistant">
  ...
  <menu>
    ...
    <item cmd="*review-literature"
       ...
       data="{project-root}/{beat_folder}/_data/sources.csv">
...
<!-- Workflow with data -->
<item cmd="*brainstorm"
   run-workflow="{project-root}/{beat_folder}/core/workflows/brainstorming/workflow.yaml"
   data="{project-root}/{beat_folder}/core/workflows/brainstorming/brain-methods.csv">
...
<item cmd="*analyze-metrics"
   ...
   data="{project-root}/{beat_folder}/_data/performance-metrics.json">
...
<item cmd="*report"
   exec="{project-root}/{beat_folder}/core/tasks/create-doc.md"
   tmpl="{project-root}/{beat_folder}/beat-method/templates/report.md"
   data="{project-root}/{beat_folder}/_data/quarterly-results.csv">
...
3. *create-agent - Build new BEAT agent
...
<item cmd="*{action}-{object}"
   run-workflow="{project-root}/{beat_folder}/{module}/workflows/{workflow}/workflow.yaml">
...
<item cmd="*validate-{object}"
   validate-workflow="{output_folder}/{document}.md"
   workflow="{project-root}/{beat_folder}/{module}/workflows/{workflow}/workflow.yaml">
...
```xml
<item cmd="*{action}"
   exec="{project-root}/{beat_folder}/{module}/tasks/{task}.md">
  {Action Description}
</item>
```
...
<item cmd="*{document}"
   exec="{project-root}/{beat_folder}/core/tasks/create-doc.md"
   tmpl="{project-root}/{beat_folder}/{module}/templates/{template}.md">
...
```xml
<agent id="{beat_folder}/research/agents/analyst.md" name="Research Analyst" icon="🔬">
  ...
  <menu>
    ...
    <item cmd="*compete"
       ...
       data="{project-root}/{beat_folder}/_data/market-data.csv">
      Analyze Competition
    </item>
    ...
    <item cmd="*report"
       exec="{project-root}/{beat_folder}/core/tasks/create-doc.md"
       tmpl="{project-root}/{beat_folder}/research/templates/report.md">
...
<agent name="Data Analyst">
  <menu>
    ...
    <item cmd="*analyze"
       ...
       data="{project-root}/{beat_folder}/_data/dataset.csv">
      Analyze Dataset
    </item>
