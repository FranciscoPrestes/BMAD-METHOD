...
```
{beat_folder}/beat-method/agents/
...
```xml
<agent id="{beat_folder}/beat-method/agents/pm.md" name="John" title="Product Manager" icon="📋">
  <persona>
  ...
  <menu>
    ...
    <item cmd="*create-prd" run-workflow="{project-root}/{beat_folder}/beat-method/workflows/prd/workflow.yaml">Create PRD</item>
