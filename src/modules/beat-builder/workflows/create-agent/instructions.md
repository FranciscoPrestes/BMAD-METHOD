...
<critical>You MUST have already loaded and processed: {project-root}/{beat_folder}/beat-builder/workflows/create-agent/workflow.yaml</critical>
<critical>Study YAML agent examples in: {project-root}/{beat_folder}/beat-method/agents/ for patterns</critical>
