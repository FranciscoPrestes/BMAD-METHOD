...
<critical>You MUST have already loaded and processed: {project-root}/{beat_folder}/beat-builder/workflows/edit-module/workflow.yaml</critical>
...
<ask>What is the path to the module you want to edit? (provide path to module directory like {beat_folder}/beat-method/ or src/modules/beat-method/)</ask>
