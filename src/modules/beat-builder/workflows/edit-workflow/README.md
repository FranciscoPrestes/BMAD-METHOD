...
An intelligent workflow editor that helps you modify existing BEAT workflows while adhering to all best practices and conventions documented in the workflow creation guide.
...
- Ensure compliance with BEAT workflow conventions
...
4. **Best Practices**: Ensures all edits follow BEAT conventions
...
- Understanding of BEAT workflow types
