...
<critical>You MUST have already loaded and processed: {project-root}/{beat_folder}/beat-builder/workflows/edit-workflow/workflow.yaml</critical>
...
- Study example workflows from: {project-root}/{beat_folder}/beat-method/workflows/
  </action>
