...
<critical>You MUST have already loaded and processed: {project-root}/{beat_folder}/beat-builder/workflows/create-module/workflow.yaml</critical>
...
<check if="create">
  <action>Invoke module-brief workflow: {project-root}/{beat_folder}/beat-builder/workflows/module-brief/workflow.yaml</action>
