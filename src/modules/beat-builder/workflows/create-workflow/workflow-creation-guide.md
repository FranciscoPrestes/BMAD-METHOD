...
web_bundle:
  ...
  instructions: '{beat_folder}/beat-method/workflows/analyze-requirements/instructions.md'
  validation: '{beat_folder}/beat-method/workflows/analyze-requirements/checklist.md'
  template: '{beat_folder}/beat-method/workflows/analyze-requirements/template.md'

  # Data files
  techniques_data: '{beat_folder}/beat-method/workflows/analyze-requirements/techniques.csv'
  patterns_data: '{beat_folder}/beat-method/workflows/analyze-requirements/patterns.json'

  # Sub-workflow reference
  validation_workflow: '{beat_folder}/beat-method/workflows/validate-requirements/workflow.yaml'

  standalone: true

  web_bundle_files:
    # Core workflow files
    - '{beat_folder}/beat-method/workflows/analyze-requirements/instructions.md'
    - '{beat_folder}/beat-method/workflows/analyze-requirements/checklist.md'
    - '{beat_folder}/beat-method/workflows/analyze-requirements/template.md'

    # Data files
    - '{beat_folder}/beat-method/workflows/analyze-requirements/techniques.csv'
    - '{beat_folder}/beat-method/workflows/analyze-requirements/patterns.json'

    # Sub-workflow and its files
    - '{beat_folder}/beat-method/workflows/validate-requirements/workflow.yaml'
    - '{beat_folder}/beat-method/workflows/validate-requirements/instructions.md'
    - '{beat_folder}/beat-method/workflows/validate-requirements/checklist.md'

    # Shared templates referenced in instructions
    - '{beat_folder}/beat-method/templates/requirement-item.md'
    - '{beat_folder}/beat-method/templates/validation-criteria.md'
```
...
- `/{beat_folder}/beat-method/workflows/` - Production examples
