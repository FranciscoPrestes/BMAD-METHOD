...
- Review `/{beat_folder}/beat-builder/workflows/create-workflow/workflow-creation-guide.md`
- Check existing workflows in `/{beat_folder}/beat-method/workflows/` for examples
- Validate against `/{beat_folder}/beat-builder/workflows/create-workflow/checklist.md`
