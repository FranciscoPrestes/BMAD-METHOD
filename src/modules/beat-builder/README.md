...
Specialized tools and workflows for creating, customizing, and extending Beat components including agents, workflows, and complete modules.
...
**Beat Builder** - Master builder agent orchestrating all creation workflows with deep knowledge of Beat architecture and conventions.

### 📋 Workflows

Comprehensive suite for building and maintaining Beat components.

## Core Workflows

### Creation Workflows

**[create-agent](./workflows/create-agent/README.md)** - Build Beat agents
...
1. **Load Beat Builder agent** in your IDE
...
- **Beat Core** - Framework foundation
...
- **[BMM Module](../beat-method/README.md)** - Reference implementation
- **[Core Framework](../../core/README.md)** - Foundation concepts

---

BMB empowers you to extend Beat Method for your specific needs while maintaining framework consistency and power.
