...
- [ ] All paths in web_bundle use {beat_folder}/-relative format (NOT {project-root})
...
- [ ] existing_workflows maps workflow variables to {beat_folder}/-relative paths correctly
