...
- **Workflows folder**: `{beat_folder}/bmm/workflows` (documents all workflows)
- **Agents folder**: `{beat_folder}/bmm/agents` (documents all agents)
- **Single workflow**: `{beat_folder}/bmm/workflows/product-brief` (documents one workflow)
- **Single agent**: `{beat_folder}/bmm/agents/prd-agent.md` (documents one agent)
