...
<!-- Standard workflow -->
<item cmd="*create-prd"
     run-workflow="{project-root}/{beat_folder}/bmm/workflows/prd/workflow.yaml">
...
<item cmd="*brief"
   ...
   tmpl="{project-root}/{beat_folder}/bmm/templates/brief.md">
  Produce Project Brief
</item>

<item cmd="*competitor-analysis"
   exec="{project-root}/{beat_folder}/core/tasks/create-doc.md"
   tmpl="{project-root}/{beat_folder}/bmm/templates/competitor.md"
...
<item cmd="*report"
   exec="{project-root}/{beat_folder}/core/tasks/create-doc.md"
   tmpl="{project-root}/{beat_folder}/bmm/templates/report.md"
