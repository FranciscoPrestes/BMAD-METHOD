...
- `id` - Unique path identifier (e.g., "{beat_folder}/bmm/agents/analyst.md")
...
```xml
<!-- Full path -->
<item cmd="*create-prd" run-workflow="{project-root}/{beat_folder}/bmm/workflows/prd/workflow.yaml">
...
```xml
<item cmd="*standup"
   exec="{project-root}/{beat_folder}/bmm/tasks/daily-standup.xml"
