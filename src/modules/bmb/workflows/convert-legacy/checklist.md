...
- [ ] ALL paths reference {project-root}/{beat_folder}/{{module}}/ locations, NOT src/
- [ ] exec, data, run-workflow commands point to final BEAT installation paths
...
- [ ] Elicitation points (elicit: true) converted to <invoke-task halt="true">{project-root}/{beat_folder}/core/tasks/adv-elicit.xml</invoke-task>
