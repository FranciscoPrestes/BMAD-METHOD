...
After installation, configure the module in `{beat_folder}/beat-gamedev/config.yaml`
...
1. Add new agents using `/beat:beat-builder:workflows:create-agent`
2. Add new workflows using `/beat:beat-builder:workflows:create-workflow`
