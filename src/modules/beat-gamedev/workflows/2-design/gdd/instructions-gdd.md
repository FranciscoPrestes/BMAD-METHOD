...
<invoke-workflow path="{project-root}/{beat_folder}/beat-method/workflows/workflow-status">
...
<check if="user selects option 1 or fuzzy indicates wanting to create the narrative design document">
  <invoke-workflow>{project-root}/{beat_folder}/beat-method/workflows/2-plan-workflows/narrative/workflow.yaml</invoke-workflow>
...
- [ ] **Run solutioning workflow** (REQUIRED)
  ...
  - Input: GDD.md, beat-method-workflow-status.md
