...
<critical>You MUST have already loaded and processed: {project-root}/{beat_folder}/bmm/workflows/3-solutioning/solutioning-gate-check/workflow.yaml</critical>
