...
**Workflow ID**: `{beat_folder}/beat-method/testarch/framework`
**Version**: 4.0 (Beat v6)
...
**Critical:** Consult `{project-root}/{beat_folder}/beat-method/testarch/tea-index.csv` to identify and load relevant knowledge fragments:
