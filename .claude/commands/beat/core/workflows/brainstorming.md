...
2. READ its entire contents - this is the CORE OS for EXECUTING the specific workflow-config beat/core/workflows/brainstorming/workflow.yaml
3. Pass the yaml path beat/core/workflows/brainstorming/workflow.yaml as 'workflow-config' parameter to the workflow.xml instructions
