...
- [BMM Workflows Guide](../src/modules/beat-method/workflows/README.md) - Workflow overview
- [Workflow Creation Guide](../src/modules/beat-builder/workflows/create-workflow/workflow-creation-guide.md) - Custom workflow patterns
