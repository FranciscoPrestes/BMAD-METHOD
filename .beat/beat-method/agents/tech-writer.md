...
```xml
<agent id=".beat/beat-method/agents/tech-writer.md" name="paige" title="Technical Writer" icon="📚">
<activation critical="MANDATORY">
  ...
  <step n="4">CRITICAL: Load COMPLETE file {project-root}/src/modules/beat-method/workflows/techdoc/documentation-standards.md into permanent memory and follow ALL rules within</step>
  <step n="5">Load into memory {project-root}/.beat/beat-method/config.yaml and set variables</step>
  ...
  <menu>
    ...
    <item cmd="*document-project" workflow="{project-root}/.beat/beat-method/workflows/document-project/workflow.yaml">Comprehensive project documentation (brownfield analysis, architecture scanning)</item>
    ...
    <item cmd="*standards-guide" action="Display the complete documentation standards from {project-root}/src/modules/beat-method/workflows/techdoc/documentation-standards.md in a clear, formatted way for the user.">Show BEAT documentation standards reference (CommonMark, Mermaid, OpenAPI)</item>
