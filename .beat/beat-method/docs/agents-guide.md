...
**Customization Directory:** `{project-root}/.beat/_cfg/agents/`
...
# {project-root}/.beat/_cfg/agents/{module}-{agent-name}.customize.yaml

# Example: .beat/_cfg/agents/bmm-pm.customize.yaml
```
