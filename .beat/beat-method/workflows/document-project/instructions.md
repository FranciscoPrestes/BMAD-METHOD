...
<critical>You MUST have already loaded and processed: {project-root}/.beat/beat-method/workflows/document-project/workflow.yaml</critical>
...
<invoke-workflow path="{project-root}/.beat/beat-method/workflows/workflow-status">
