...
<critical>You MUST have already loaded and processed: {project-root}/.beat/beat-method/workflows/workflow-status/workflow.yaml</critical>
...
**Command:** /beat:beat-method:workflows:{{next_workflow_id}}
