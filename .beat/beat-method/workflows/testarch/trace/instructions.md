...
1. Load relevant knowledge fragments from `{project-root}/.beat/beat-method/testarch/tea-index.csv`:
...
- Traceability Matrix: `.beat/output/traceability-matrix.md`
- Test Design: `.beat/output/test-design-epic-2.md`
- Test Results: `ci-artifacts/test-report-2025-01-15.xml`
- NFR Assessment: `.beat/output/nfr-assessment-release-1.2.md`
```
...
1. **Update workflow status** (if `append_to_history: true`):
   ...
   - Format:
     ...
     - **Document**: [gate-decision-story-1.3.md](.beat/output/gate-decision-story-1.3.md)
...
2. **Generate stakeholder notification** (if `notify_stakeholders: true`):
   ...
   Full Report: .beat/output/gate-decision-story-1.3.md
   ```
