...
7. **When refactoring complete**, run `beat sm story-done` to move story to DONE
...
- Refer to `./beat-method/docs/tea-README.md` for workflow documentation
- Consult `./beat-method/testarch/knowledge` for testing best practices

---

**Generated by Beat TEA Agent** - {date}
