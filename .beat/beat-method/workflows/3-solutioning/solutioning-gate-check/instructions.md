...
<critical>You MUST have already loaded and processed: {project-root}/.beat/beat-method/workflows/3-solutioning/solutioning-gate-check/workflow.yaml</critical>
