...
- Source: `.beat/agents/{filename}.agent.yaml`
- Compiled: `.beat/agents/{filename}.md`

**Module Agents:**

- Source: `src/modules/{module}/agents/{filename}.agent.yaml`
- Compiled: `.beat/{module}/agents/{filename}.md`
...
agent:
  metadata:
    id: .beat/{module}/agents/{filename}.md
    name: Agent Name
    title: Agent Title
    icon: 🤖
    module: module-name
...
Location: `.beat/_cfg/agents/{module}-{filename}.customize.yaml`
