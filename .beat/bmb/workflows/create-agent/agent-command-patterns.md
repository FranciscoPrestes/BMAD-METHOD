...
<!-- Standard workflow -->
<item cmd="*create-prd"
     run-workflow="{project-root}/.beat/bmm/workflows/prd/workflow.yaml">
...
<item cmd="*validate-prd"
     ...
     workflow="{project-root}/.beat/bmm/workflows/prd/workflow.yaml">
...
<item cmd="*brief"
   ...
   tmpl="{project-root}/.beat/bmm/templates/brief.md">
  Produce Project Brief
</item>

<item cmd="*competitor-analysis"
   exec="{project-root}/.beat/core/tasks/create-doc.md"
   tmpl="{project-root}/.beat/bmm/templates/competitor.md"
...
<item cmd="*report"
   exec="{project-root}/.beat/core/tasks/create-doc.md"
   tmpl="{project-root}/.beat/bmm/templates/report.md"
