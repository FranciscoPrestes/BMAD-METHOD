...
- `id` - Unique path identifier (e.g., ".beat/bmm/agents/analyst.md")
...
```xml
<!-- Full path -->
<item cmd="*create-prd" run-workflow="{project-root}/.beat/bmm/workflows/prd/workflow.yaml">
...
```xml
<item cmd="*standup"
   exec="{project-root}/.beat/bmm/tasks/daily-standup.xml"
