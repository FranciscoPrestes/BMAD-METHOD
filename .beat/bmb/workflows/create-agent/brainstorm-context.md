...
_Context provided to brainstorming workflow when creating a new BEAT agent_

## Session Focus

You are brainstorming ideas for a **BEAT agent** - an AI persona with specific expertise, personality, and capabilities that helps users accomplish tasks through commands and workflows.

## What is a BEAT Agent?
...
_This focused context helps create distinctive, useful BEAT agents_
