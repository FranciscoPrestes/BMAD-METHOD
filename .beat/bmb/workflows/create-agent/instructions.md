...
<critical>You MUST have already loaded and processed: {project-root}/.beat/bmb/workflows/create-agent/workflow.yaml</critical>
<critical>Study YAML agent examples in: {project-root}/.beat/bmm/agents/ for patterns</critical>
