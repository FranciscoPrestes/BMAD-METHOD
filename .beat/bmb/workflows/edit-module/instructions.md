...
<critical>You MUST have already loaded and processed: {project-root}/.beat/bmb/workflows/edit-module/workflow.yaml</critical>
...
<ask>What is the path to the module you want to edit? (provide path to module directory like .beat/bmm/ or src/modules/bmm/)</ask>
