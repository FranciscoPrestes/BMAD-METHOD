...
- **Workflows folder**: `.beat/bmm/workflows` (documents all workflows)
- **Agents folder**: `.beat/bmm/agents` (documents all agents)
- **Single workflow**: `.beat/bmm/workflows/product-brief` (documents one workflow)
- **Single agent**: `.beat/bmm/agents/prd-agent.md` (documents one agent)
