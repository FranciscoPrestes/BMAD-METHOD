...
_Context provided to brainstorming workflow when creating a new BEAT workflow_

## Session Focus

You are brainstorming ideas for a **BEAT workflow** - a guided, multi-step process that helps users accomplish complex tasks with structure, consistency, and quality.

## What is a BEAT Workflow?
...
A great BEAT workflow should be:
...
_This focused context helps create valuable, structured BEAT workflows_
