...
<critical>You MUST have already loaded and processed: {project-root}/.beat/bmb/workflows/create-workflow/workflow.yaml</critical>
...
2. Convert all file paths to .beat/-relative paths:
   ...
   - Example: "{project-root}/.beat/bmm/workflows/x" → ".beat/bmm/workflows/x"
...
web_bundle:
  ...
  author: 'Beat'
  instructions: '.beat/bmm/workflows/brainstorm-game/instructions.md'
  template: false
  web_bundle_files:
    - '.beat/bmm/workflows/brainstorm-game/instructions.md'
