...
- Review `/.beat/bmb/workflows/create-workflow/workflow-creation-guide.md`
- Check existing workflows in `/.beat/bmm/workflows/` for examples
- Validate against `/.beat/bmb/workflows/create-workflow/checklist.md`
