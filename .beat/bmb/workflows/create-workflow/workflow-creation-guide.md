...
web_bundle:
  ...
  instructions: '.beat/bmm/workflows/analyze-requirements/instructions.md'
  validation: '.beat/bmm/workflows/analyze-requirements/checklist.md'
  template: '.beat/bmm/workflows/analyze-requirements/template.md'

  # Data files
  techniques_data: '.beat/bmm/workflows/analyze-requirements/techniques.csv'
  patterns_data: '.beat/bmm/workflows/analyze-requirements/patterns.json'

  # Sub-workflow reference
  validation_workflow: '.beat/bmm/workflows/validate-requirements/workflow.yaml'

  standalone: true

  web_bundle_files:
    # Core workflow files
    - '.beat/bmm/workflows/analyze-requirements/instructions.md'
    - '.beat/bmm/workflows/analyze-requirements/checklist.md'
    - '.beat/bmm/workflows/analyze-requirements/template.md'

    # Data files
    - '.beat/bmm/workflows/analyze-requirements/techniques.csv'
    - '.beat/bmm/workflows/analyze-requirements/patterns.json'

    # Sub-workflow and its files
    - '.beat/bmm/workflows/validate-requirements/workflow.yaml'
    - '.beat/bmm/workflows/validate-requirements/instructions.md'
    - '.beat/bmm/workflows/validate-requirements/checklist.md'

    # Shared templates referenced in instructions
    - '.beat/bmm/templates/requirement-item.md'
    - '.beat/bmm/templates/validation-criteria.md'
```
...
- `/.beat/bmm/workflows/` - Production examples
