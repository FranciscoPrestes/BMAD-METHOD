...
menu:
  - trigger: command-name
    workflow: '{project-root}/.beat/SOURCE_MODULE/workflows/path/workflow.yaml'
    workflow-install: '{project-root}/.beat/THIS_MODULE/workflows/vendored/workflow.yaml'
...
data_path:
  result: '{project-root}/.beat/module-code/data'
```
