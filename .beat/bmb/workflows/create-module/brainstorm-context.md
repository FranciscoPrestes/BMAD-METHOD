...
_Context provided to brainstorming workflow when creating a new BEAT module_

## Session Focus

You are brainstorming ideas for a **complete BEAT module** - a self-contained package that extends the BEAT Method with specialized domain expertise and capabilities.

## What is a BEAT Module?
...
_This focused context helps create cohesive, valuable BEAT modules_
