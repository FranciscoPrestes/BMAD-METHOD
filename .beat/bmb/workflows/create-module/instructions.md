...
<critical>You MUST have already loaded and processed: {project-root}/.beat/bmb/workflows/create-module/workflow.yaml</critical>
...
<check if="create">
  <action>Invoke module-brief workflow: {project-root}/.beat/bmb/workflows/module-brief/workflow.yaml</action>
