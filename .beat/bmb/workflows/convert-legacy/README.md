...
- Review the workflow creation guide at `/.beat/bmb/workflows/create-workflow/workflow-creation-guide.md`
- Check conversion mappings at `/.beat/bmb/data/v4-to-v6-mappings.yaml`
