...
<critical>You MUST have already loaded and processed: {project-root}/.beat/bmb/workflows/edit-workflow/workflow.yaml</critical>
...
- Study example workflows from: {project-root}/.beat/bmm/workflows/
  </action>
