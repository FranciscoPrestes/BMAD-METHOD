<!-- BEAT BMM Story Context Assembly Instructions (v6) -->
...
3. **Cancel** - Exit without changes
  ...
  <step n="6" goal="Validate and save">
    ...
    <invoke-task>Validate against checklist at {installed_path}/checklist.md using .beat/core/tasks/validate-workflow.xml</invoke-task>
  </step>
