...
<critical>You MUST have already loaded and processed: {project-root}/.beat/bmm/workflows/document-project/workflow.yaml</critical>
...
<invoke-workflow path="{project-root}/.beat/bmm/workflows/workflow-status">
