...
**Workflow ID**: `.beat/bmm/testarch/framework`
**Version**: 4.0 (Beat v6)
...
**Critical:** Consult `{project-root}/.beat/bmm/testarch/tea-index.csv` to identify and load relevant knowledge fragments:
