...
**Note:** Beat artifacts (story, tech-spec, PRD) are OPTIONAL - workflow can run without them
...
- [ ] **Note**: Absence of Beat artifacts does NOT halt workflow
...
**Beat-Integrated Mode (if story available):**
...
- [ ] Document includes execution mode (Beat-Integrated, Standalone, Auto-discover)
...
### With Beat Workflows (If Available - OPTIONAL)
...
### Issue: Beat artifacts not found

**Problem:** Story, tech-spec, or PRD files not found when variables are set.

**Resolution:**

- **automate does NOT require Beat artifacts** - they are OPTIONAL enhancements
- If files not found, switch to Standalone Mode automatically
- Analyze source code directly without Beat context
...
- Message: "Framework scaffolding required. Run `beat tea *framework` first."
...
- **automate is flexible:** Can work with or without Beat artifacts (story, tech-spec, PRD are OPTIONAL)
