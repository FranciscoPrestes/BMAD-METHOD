...
Complete guides for the Beat Method Module (BMM) - AI-powered agile development workflows that adapt to your project's complexity.
...
- **[Scale Adaptive System](./scale-adaptive-system.md)** - How BMM adapts to project size and complexity (42 min read)
  - Three planning tracks (Quick Flow, Beat Method, Enterprise Method)
...
- **[Agents Guide](./agents-guide.md)** - Comprehensive agent reference (45 min read)
  - 12 specialized BMM agents + Beat Master
...
- **[Phase 2: Planning Workflows](./workflows-planning.md)** - Scale-adaptive planning (967 lines)
  ...
  - Track-based planning approach (Quick Flow, Beat Method, Enterprise Method)
...
- **[Phase 3: Solutioning Workflows](./workflows-solutioning.md)** - Architecture and validation (638 lines)
  ...
  - Required for Beat Method and Enterprise Method tracks
...
- **[Testing & QA Workflows](./test-architecture.md)** - Comprehensive quality assurance (1,420 lines)
  ...
  - Beat-integrated vs standalone modes
...
- **[GitHub Issues](https://github.com/beat-code-org/BEAT-METHOD/issues)** - Report bugs or request features
