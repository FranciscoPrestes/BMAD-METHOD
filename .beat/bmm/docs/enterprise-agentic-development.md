...
**Anti-pattern:** Adding `.beat/` to `.gitignore` breaks IDE tools, submodule management.
...
# Make personal customizations in .beat/
```
...
```bash
cd /path/to/your-project
# Beat available at ./.beat/, load agents normally
```
