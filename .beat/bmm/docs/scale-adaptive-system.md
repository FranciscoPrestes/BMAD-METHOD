# Beat Method Scale Adaptive System
...
Beat Method adapts to three distinct planning tracks:

- **Quick Flow**: Tech-spec only, implement immediately
- **Beat Method**: PRD + Architecture, structured approach
...
| **Beat Method**       | PRD + Arch + UX       | 1-3 days        | Products, platforms, complex features      |
...
flowchart TD
    ...
    START -->|Product, platform, complex| M[Beat Method<br/>PRD + Architecture]
...
- **Beat Method**: product, platform, dashboard, complex, multiple features
...
```
workflow-init: "Based on 'Add user dashboard with analytics', I recommend Beat Method.
...
Includes all Beat Method documents PLUS:
...
| **Beat Method** | Recommended | PRD + UX  | Required     | None         | 10-50+          |
...
### Scenario 3: Customer Portal (Beat Method)
...
### Scenario 4: E-commerce Platform (Beat Method)
...
If `workflow-init` suggests Beat Method, there's probably complexity you haven't considered. Review carefully before overriding.
...
For Beat Method and Enterprise, gate checks prevent costly mistakes. Invest the time.

### 5. Architecture is Optional but Recommended for Brownfield

Brownfield Beat Method makes architecture optional, but it's highly recommended. It distills complex codebase into focused solution design.
...
Product Brief is only offered for greenfield Beat Method and Enterprise. It's optional but helps with strategic thinking.
...
- Clear track purposes:
  ...
  - Beat Method = Product + system design
