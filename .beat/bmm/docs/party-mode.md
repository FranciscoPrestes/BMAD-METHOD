...
1. Party mode reads `.beat/_cfg/agent-manifest.csv`
...
Party mode uses agents from `.beat/[module]/agents/*.md` - these already include any customizations you applied during install.

**To customize agents for party mode:**

1. Create customization file: `.beat/_cfg/agents/bmm-pm.customize.yaml`
