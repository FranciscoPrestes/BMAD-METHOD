...
```xml
<agent id=".beat/bmm/agents/tech-writer.md" name="paige" title="Technical Writer" icon="📚">
<activation critical="MANDATORY">
  ...
  <step n="5">Load into memory {project-root}/.beat/bmm/config.yaml and set variables</step>
  ...
  <menu>
    ...
    <item cmd="*document-project" workflow="{project-root}/.beat/bmm/workflows/document-project/workflow.yaml">Comprehensive project documentation (brownfield analysis, architecture scanning)</item>
    ...
    <item cmd="*standards-guide" action="Display the complete documentation standards from {project-root}/src/modules/bmm/workflows/techdoc/documentation-standards.md in a clear, formatted way for the user.">Show BEAT documentation standards reference (CommonMark, Mermaid, OpenAPI)</item>
