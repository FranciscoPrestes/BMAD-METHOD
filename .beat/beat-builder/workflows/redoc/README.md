...
- **Module path**: `.beat/bmm` (documents entire module: root, workflows, agents)
- **Workflows folder**: `.beat/beat-method/workflows` (documents all workflows)
- **Agents folder**: `.beat/beat-method/agents` (documents all agents)
- **Single workflow**: `.beat/beat-method/workflows/product-brief` (documents one workflow)
- **Single agent**: `.beat/beat-method/agents/prd-agent.md` (documents one agent)
