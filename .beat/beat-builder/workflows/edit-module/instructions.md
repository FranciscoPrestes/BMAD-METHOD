...
<critical>You MUST have already loaded and processed: {project-root}/.beat/beat-builder/workflows/edit-module/workflow.yaml</critical>
...
<ask>What is the path to the module you want to edit? (provide path to module directory like .beat/beat-method/ or src/modules/beat-method/)</ask>
...
- Show how to reference workflows properly: {project-root}/.beat/{{module}}/workflows/{{workflow}}/workflow.yaml
