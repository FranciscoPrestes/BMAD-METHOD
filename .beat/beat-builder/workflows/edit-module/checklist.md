...
- [ ] Module has clear 3-letter code (beat-method, beat-builder, cis, etc.)
- [ ] Module is in correct location (src/modules/ for source, .beat/ for installed)
...
- [ ] Paths are .beat/-relative (not project-root)
