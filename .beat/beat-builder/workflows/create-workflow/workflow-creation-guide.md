...
installed_path: '{project-root}/.beat/module/workflows/my-workflow'
...
<critical>The workflow execution engine is governed by: {project_root}/.beat/core/tasks/workflow.xml</critical>
...
| **Location**   | `/src/core/tasks/` | `/.beat/*/workflows/`   |
...
# Paths
installed_path: '{project-root}/.beat/module/workflows/name'
...
beat-method/workflows/plan-project/workflow.yaml → standalone: true
beat-method/workflows/architecture/workflow.yaml → standalone: true

# Helper workflows: standalone: false
beat-method/workflows/internal/validate-epic/workflow.yaml → standalone: false
beat-method/workflows/internal/format-story/workflow.yaml → standalone: false
```
...
- `<invoke-task halt="true">{project-root}/.beat/core/tasks/adv-elicit.xml</invoke-task>` - Trigger AI enhancement
...
<workflow>
  ...
  <step n="2" goal="Define requirements">
    ...
    <invoke-task halt="true">{project-root}/.beat/core/tasks/adv-elicit.xml</invoke-task>
  </step>
...
- Full Load: `src/modules/beat-method/workflows/2-plan-workflows/prd/`
- Selective Load: `src/modules/beat-method/workflows/4-implementation/epic-tech-context/`
...
4. **Relative Paths**: Use `.beat/` root paths (no `{project-root}`)
...
web_bundle:
  ...
  # Core files (.beat/-relative paths)
  instructions: '.beat/module/workflows/workflow/instructions.md'
  validation: '.beat/module/workflows/workflow/checklist.md'
  template: '.beat/module/workflows/workflow/template.md'

  # Data files (no config_source allowed)
  data_file: '.beat/module/workflows/workflow/data.csv'

  # Complete file list - CRITICAL!
  web_bundle_files:
    - '.beat/module/workflows/workflow/instructions.md'
    - '.beat/module/workflows/workflow/checklist.md'
    - '.beat/module/workflows/workflow/template.md'
    - '.beat/module/workflows/workflow/data.csv'
...
1. **Remove Config Dependencies**:
   ...
   - Convert `{project-root}/.beat/` to `.beat/`
...
3. **Test Completeness**:
   ...
   - Verify all paths are relative to .beat/
...
web_bundle:
  ...
  instructions: '.beat/beat-method/workflows/analyze-requirements/instructions.md'
  validation: '.beat/beat-method/workflows/analyze-requirements/checklist.md'
  template: '.beat/beat-method/workflows/analyze-requirements/template.md'

  # Data files
  techniques_data: '.beat/beat-method/workflows/analyze-requirements/techniques.csv'
  patterns_data: '.beat/beat-method/workflows/analyze-requirements/patterns.json'

  # Sub-workflow reference
  validation_workflow: '.beat/beat-method/workflows/validate-requirements/workflow.yaml'

  standalone: true

  web_bundle_files:
    # Core workflow files
    - '.beat/beat-method/workflows/analyze-requirements/instructions.md'
    - '.beat/beat-method/workflows/analyze-requirements/checklist.md'
    - '.beat/beat-method/workflows/analyze-requirements/template.md'

    # Data files
    - '.beat/beat-method/workflows/analyze-requirements/techniques.csv'
    - '.beat/beat-method/workflows/analyze-requirements/patterns.json'

    # Sub-workflow and its files
    - '.beat/beat-method/workflows/validate-requirements/workflow.yaml'
    - '.beat/beat-method/workflows/validate-requirements/instructions.md'
    - '.beat/beat-method/workflows/validate-requirements/checklist.md'

    # Shared templates referenced in instructions
    - '.beat/beat-method/templates/requirement-item.md'
    - '.beat/beat-method/templates/validation-criteria.md'
```
...
- `/.beat/beat-method/workflows/` - Production examples
