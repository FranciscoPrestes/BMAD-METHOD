...
`{project-root}/.beat/{{target_module}}/workflows/{{workflow_name}}/`
...
- Module to host the new workflow (beat-method, beat-builder, cis, or custom)
...
- Review `/.beat/beat-builder/workflows/create-workflow/workflow-creation-guide.md`
- Check existing workflows in `/.beat/beat-method/workflows/` for examples
- Validate against `/.beat/beat-builder/workflows/create-workflow/checklist.md`
