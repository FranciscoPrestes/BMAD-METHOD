...
<!-- Standard workflow -->
<item cmd="*create-prd"
     run-workflow="{project-root}/.beat/beat-method/workflows/prd/workflow.yaml">
...
<item cmd="*validate-prd"
     ...
     workflow="{project-root}/.beat/beat-method/workflows/prd/workflow.yaml">
...
<!-- Simple task -->
<item cmd="*validate"
   exec="{project-root}/.beat/core/tasks/validate-workflow.xml">
  Validate document against checklist
</item>

<!-- Task with data -->
<item cmd="*standup"
   exec="{project-root}/.beat/mmm/tasks/daily-standup.xml"
   data="{project-root}/.beat/_cfg/agent-manifest.csv">
...
```xml
<item cmd="*brief"
   exec="{project-root}/.beat/core/tasks/create-doc.md"
   tmpl="{project-root}/.beat/beat-method/templates/brief.md">
  Produce Project Brief
</item>

<item cmd="*competitor-analysis"
   exec="{project-root}/.beat/core/tasks/create-doc.md"
   tmpl="{project-root}/.beat/beat-method/templates/competitor.md"
   data="{project-root}/.beat/_data/market-research.csv">
...
<item cmd="*list-tasks"
   action="list all tasks from {project-root}/.beat/_cfg/task-manifest.csv">
...
<agent name="Research Assistant">
  ...
  <menu>
    ...
    <item cmd="*review-literature"
       ...
       data="{project-root}/.beat/_data/sources.csv">
...
<!-- Workflow with data -->
<item cmd="*brainstorm"
   run-workflow="{project-root}/.beat/core/workflows/brainstorming/workflow.yaml"
   data="{project-root}/.beat/core/workflows/brainstorming/brain-methods.csv">
...
<item cmd="*analyze-metrics"
   ...
   data="{project-root}/.beat/_data/performance-metrics.json">
...
<item cmd="*report"
   exec="{project-root}/.beat/core/tasks/create-doc.md"
   tmpl="{project-root}/.beat/beat-method/templates/report.md"
   data="{project-root}/.beat/_data/quarterly-results.csv">
...
<item cmd="*{action}-{object}"
   run-workflow="{project-root}/.beat/{module}/workflows/{workflow}/workflow.yaml">
...
<item cmd="*validate-{object}"
   validate-workflow="{output_folder}/{document}.md"
   workflow="{project-root}/.beat/{module}/workflows/{workflow}/workflow.yaml">
...
```xml
<item cmd="*{action}"
   exec="{project-root}/.beat/{module}/tasks/{task}.md">
  {Action Description}
</item>
```
...
<item cmd="*{document}"
   exec="{project-root}/.beat/core/tasks/create-doc.md"
   tmpl="{project-root}/.beat/{module}/templates/{template}.md">
...
```xml
<agent id=".beat/research/agents/analyst.md" name="Research Analyst" icon="🔬">
  ...
  <menu>
    ...
    <item cmd="*compete"
       ...
       data="{project-root}/.beat/_data/market-data.csv">
      Analyze Competition
    </item>
    ...
    <item cmd="*report"
       exec="{project-root}/.beat/core/tasks/create-doc.md"
       tmpl="{project-root}/.beat/research/templates/report.md">
...
<agent name="Data Analyst">
  <menu>
    ...
    <item cmd="*analyze"
       ...
       data="{project-root}/.beat/_data/dataset.csv">
      Analyze Dataset
    </item>
