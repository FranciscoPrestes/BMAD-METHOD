...
- [ ] ALL paths reference {project-root}/.beat/{{module}}/ locations, NOT src/
...
- [ ] Elicitation points (elicit: true) converted to <invoke-task halt="true">{project-root}/.beat/core/tasks/adv-elicit.xml</invoke-task>
