...
<critical>You MUST have already loaded and processed: {project-root}/.beat/beat-builder/workflows/edit-workflow/workflow.yaml</critical>
...
- Study example workflows from: {project-root}/.beat/beat-method/workflows/
  </action>
...
- Verify paths are .beat/-relative
